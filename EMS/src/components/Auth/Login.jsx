      ...
      <div className="border-2 rounded-xl border-emerald-600 p-20">
        ...
        >
          <input
            ...
            className=""
            type="email"
            placeholder="Enter your emailoutline-none bg-transparent border-2 border-emerald-600 font-medium text-lg py-2 px-6 rounded-full placeholder:text-gray-400"
          />
          <input
            value={password}
            onChange={(e) => {
